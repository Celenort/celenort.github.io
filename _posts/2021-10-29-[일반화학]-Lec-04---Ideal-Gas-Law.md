...
pin: false
image:
  path: "/assets/img/2021-10-29-[일반화학]-Lec-04---Ideal-Gas-Law/0.png"
...
- Graham’s Law of effusion : 서로다른 두 gas가 용출될 때 그 비율은 분자량이 제곱근의 비를 따름.
	...
	![](/assets/img/2021-10-29-[일반화학]-Lec-04---Ideal-Gas-Law/0.png)
...
- Z<1이다 : 동일 P, T 조건에서 V가 PV=nRT의 갑보다 더 작게 나옴
	...
	![](/assets/img/2021-10-29-[일반화학]-Lec-04---Ideal-Gas-Law/1.png)
