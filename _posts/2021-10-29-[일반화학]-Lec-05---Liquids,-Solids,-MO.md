...
pin: false
image:
  path: "/assets/img/2021-10-29-[일반화학]-Lec-05---Liquids,-Solids,-MO/0-5c20dcbcfb.png"
...
![](/assets/img/2021-10-29-[일반화학]-Lec-05---Liquids,-Solids,-MO/0-5c20dcbcfb.png)
...
![](/assets/img/2021-10-29-[일반화학]-Lec-05---Liquids,-Solids,-MO/1-278cadb5c5.png)
...
2. Metallic solids
	- 좁은 공간 안에 최대한 많이 응집하려고 함. - 아래 층의 빈공간에 다음 층이 올라가는 방식
		...
		![](/assets/img/2021-10-29-[일반화학]-Lec-05---Liquids,-Solids,-MO/2-bd473197c4.png)
...
![](/assets/img/2021-10-29-[일반화학]-Lec-05---Liquids,-Solids,-MO/3-e3039f248d.png)
...
- FCC에서의 Octahedral intersite : 13개, (4+5+4) / Tetrahedral intersite : 8개
	...
	![](/assets/img/2021-10-29-[일반화학]-Lec-05---Liquids,-Solids,-MO/4-ee673444da.png)
...
![](/assets/img/2021-10-29-[일반화학]-Lec-05---Liquids,-Solids,-MO/5-a3e9b924b0.png)
...
- Metalic solid의 경우 원자가 매우 많으므로 orbital간의 에너지 준위 격차가 매우 작음, Band 형성
	...
	![](/assets/img/2021-10-29-[일반화학]-Lec-05---Liquids,-Solids,-MO/6-cae856732b.png)

- 이 때 실제 MO처럼 Orbital 안에 전자가 차있는 곳, 차있지 않은 곳이 존재하므로 이를 각각 valance band, conductive band라고 명명

	![](/assets/img/2021-10-29-[일반화학]-Lec-05---Liquids,-Solids,-MO/7-073efc852a.png)
