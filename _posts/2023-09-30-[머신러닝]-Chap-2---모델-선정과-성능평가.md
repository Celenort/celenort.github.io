...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\lim\limits_{m\rightarrow \infty} \bigg(1-\frac{1}{m}\bigg)^m = \frac{1}{e}\approx 0.368
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}E(f;D) = \frac{1}{m} \sum_{i=1}^m (f({\bf x_i})-y_i)^2
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}E(f;D) = \int_{x\sim D} (f({\bf x})-y)^2 p({\bf x} ) d({\bf x})
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}E(f;D) = \frac{1}{m} \sum_{i=1}^m II(f({\bf x_i})\neq y_i)
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}acc(f;D) = \frac{1}{m} \sum_{i=1}^m II(f({\bf x_i})= y_i)
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}acc = \frac{TP+TN} {TP+TN+FP+FN}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}prec = \frac{TP} {TP+FP}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}rec = \frac{TP} {TP + FN}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\text{F1 score = } \frac{2PR}{P+R}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}F_\beta = \frac{(1+\beta^2)\times P \times R} {(\beta^2\times P) + R}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}TPR = \frac{TP}{TP+FN}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}FPR = \frac{FP}{TN+FP}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}P(+)cost = \frac{p \times cost_{01}}{p\times cost_{01}+(1-p)\times cost_{10}}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}cost_{norm} = \frac{FNR \times p \times cost_{01} + FPR \times (1-p)\times cost_{10}} {p\times cost_{01} + (1-p)\times cost_{10}}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\tau_t = \frac{\sqrt k (\mu-\epsilon_0)}{\sigma}\sim t(k-1)
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\tau_t = \vert\frac{\sqrt{k}\mu}{\sigma}\vert
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\sigma_i^2 = \bigg(\Delta_i^1-\frac{\Delta_i^1+\Delta_i^2}{2}\bigg)^2+\bigg(\Delta_i^2-\frac{\Delta_i^1+\Delta_i^2}{2}\bigg)^2
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\tau_t = \frac{\mu}{\sqrt{0.2 \sum_{i=1}^5 \sigma_i^2}}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\tau_{\chi^2} = \frac{(\vert e_{01}-e_{10}\vert -1)^2}{e_{01}+e_{10}} \sim \chi^2_1
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\tau_{\chi^2} = \frac{k-1}{k} \cdot \frac{12N}{k^2-1} \sum_{i=1}^k \bigg(r_i-\frac{k+1}{2}\bigg)^2 \sim \chi^2_{k-1}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\tau_F = \frac{(N-1)\tau_{\chi^2}}{N(k-1)-\tau_{\chi^2}}\sim F_{k-1, (k-1)(N-1)}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}CD = q_\alpha \sqrt{\frac{k(k+1)}{6N}}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\bar f({\bf x}) = E_D[f({\bf x}, D)]
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}var({\bf x}) = E_D[(f({\bf x}, D)-\bar f({\bf x}))^2]
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\epsilon^2 = E_D[(y_D-y)^2]
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}bias^2({\bf x}) = (\bar f({\bf x})-y)^2
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\begin{aligned} Error(f;D) =& E_D [(f({\bf x};D)-y_D)^2]\\ =& E_D[(f({\bf x};D)-\bar f({\bf x})+\bar f({\bf x})-y_D)^2]\\ =& var({\bf x}) + E_D[(\bar f({\bf x})-y_D)^2]\\ &+ E_D[2(f({\bf x};D)-\bar f({\bf x}))(\bar f({\bf x})-y_D)] \\ =& var({\bf x}) + E_D[(\bar f({\bf x})-y+y-y_D)^2] \\ =& var({\bf x})+((\bar f({\bf x})-y)^2+E_D[(y_D-y)^2]\end{aligned}
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
...
${leadingWhitespace}{% raw %}
${leadingWhitespace}$$
${leadingWhitespace}\therefore Error(f;D) = bias^2({\bf x})+ var({\bf x})+\epsilon^2
${leadingWhitespace}$$
${leadingWhitespace}{% endraw %}
